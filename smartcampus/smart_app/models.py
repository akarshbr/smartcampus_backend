...
class Enqui_student(models.Model):
    user_name = models.ForeignKey(CustomUser,on_delete=models.CASCADE, related_name='enquiries')
    description = models.TextField()
    enq_date = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"Enquiry by {self.user_name.username} on {self.enq_date}"