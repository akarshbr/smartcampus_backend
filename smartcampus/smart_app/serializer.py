...
class CustomUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id','username','first_name', 'middle_name', 'last_name', 'image', 'admission_number', 'date_of_birth',
...
class ProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomUser
        fields = [ 'username','first_name', 'middle_name', 'last_name', 'email', 'image',  'date_of_birth', 'blood_group', 'place', 'phone_number', 'department', 'course', 'batch', 'start_year', 'end_year','barcode']
        
class Enqui_studentSerializer(serializers.ModelSerializer):
